...
class PlaceApiClient implements ApiClient
{
    ...
    public function makeCall($param = null)
    {
        ...
        $response['photo'] = 'https://maps.googleapis.com/maps/api/place/photo?maxwidth=100&maxheight=80&photoreference='.$jsonRes['results'][0]['photos'][0]['photo_reference'].'&key=AIzaSyClXr-C6_i6edx5e3eoxQAkZccCM93jun4';
